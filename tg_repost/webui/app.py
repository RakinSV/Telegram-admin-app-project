...
from tg_repost.webui.subscriptions_routes import build_subscriptions_router
...
from tg_repost.webui.invites_routes import build_invites_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(build_miniapp_router())
