...
def cosine_similarity(a: list[float], b: list[float]) -> float:
    ...
    if not a or not b or len(a) != len(b):
        return 0.0
    # strict=True здесь не про безопасность, а про честность: равенство
    # длин проверено строкой выше, и если проверку однажды уберут, лучше
    # получить ошибку, чем молча посчитать сходство по короткому вектору.
